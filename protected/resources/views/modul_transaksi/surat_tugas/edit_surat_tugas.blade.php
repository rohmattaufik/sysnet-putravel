...
<form class="form-horizontal" method="post" action="{{url(action('TransaksiSuratTugasController@update'))}}">
    {{ csrf_field() }}
                        ...
                        <div class="box-body">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <textarea class="form-control" rows="3" id="keterangan" name="keterangan">{!! html_entity_decode($data_surat[0]['description']) !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <textarea class="form-control" rows="3"
                                                    ...
                                                    placeholder="Masukkan Keterangan Tambahan">{{ $data_surat[0]['description_1'] }}</textarea>
                                    </div>
                                </div>
