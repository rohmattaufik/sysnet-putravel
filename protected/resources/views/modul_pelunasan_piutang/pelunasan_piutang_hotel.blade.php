                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    @for($j=1,$i=0;$i<count($data);$i++,$j++)
                                                                        @if(count($data[$i]) > 0)
                                                                            <form method="post" action="{{ url(action('PelunasanPiutangHotelController@store')) }}">
                                                                                {{ csrf_field() }}
                                                                                <table class="table table-bordered" id="dynamic_field">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="text-nowrap" rowspan="{{ count($data[$i]) }}">
                                                                                            <p>Rp <span class="uang">{{ $data[$i]['total_payment'] }}</span></p>
                                                                                        </td>
                                                                                        <td class="text-nowrap" rowspan="{{ count($data[$i]) }}">
                                                                                            <div class="form-group">
                                                                                                <div class="checkbox">
                                                                                        ...
                                                                                        <td class="text-nowrap" rowspan="{{ count($data[$i]) }}">
                                                                                            <input type="hidden" value="{{$data[$i]["id"]}}" name="id_hotel_h" hidden>
                                                                                ...
                                                                                <table class="table table-bordered" id="dynamic_field">
                                                                                    ...
                                                                                    @foreach($data[$i]["data_pesan_hotel"] as $data_pesan)
                                                                                        <tr>
                                                                                            <td class="text-nowrap">
                                                                                                <p>{{ $data_pesan->employee_name}}</p>
                                                                                            </td>
                                                                                            <td class="text-nowrap">
                                                                                                <p>{{ $data_pesan->city_name }}</p>
                                                                                            </td>
                                                                                            <td class="text-nowrap">
                                                                                                <p>{{ $data_pesan->supplier_name }}</p>
                                                                                            </td>
                                                                                            <td class="text-nowrap">
                                                                                                <p>{{ \Carbon\Carbon::parse($data_pesan->checkin_date)->format('d-m-Y')  }}</p>
                                                                                            </td>
                                                                                            <td class="text-nowrap">
                                                                                                <p>{{ \Carbon\Carbon::parse($data_pesan->checkout_date)->format('d-m-Y')  }}</p>
                                                                                            </td>
                                                                                            <td class="text-nowrap">
                                                                                                <p>Rp <span class="uang">{{ $data_pesan->AR_price }}</span></p>
                                                                                            </td>
                                                                                            <td class="text-nowrap">
                                                                                                <div class="input-group" style="width: 100%; ">
                                                                                                    <input type="text"
                                                                                                           name="nilai_bayar[{{ $data_pesan->id }}]"
...
{{--                                                                                                <p>Rp <span class="uang">{{ $data_pesan->AP_price }}</span></p>--}}
                                                                                            </td>
                                                                                            <td>
                                                                                                <div class="form-group">
                                                                                                    <p>
                                                                                                        <input type="checkbox" value="{{ $data_pesan->id }}" id="title_{{$i}}" name="id_hotel_d[]">
                                                                                                    </p>
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
