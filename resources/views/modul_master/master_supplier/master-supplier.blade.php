                                ...
                                @foreach($data_supplier as $data)
                                    <tr>
                                        <form method="post" action="{{ url(action('MasterSupplierController@delete')) }}">
                                            ...
                                            <td>{{ $data->supplier_type_name }} aaaaaaaaaaaaaaaaaa</td>
                                            <td>{{ $data->supplier_name }} aaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaa</td>
                                            <td>{{ $data->supplier_address }} aaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaa</td>
                                            <td>{{ $data->city_name }} aaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaa</td>
                                            <td>{{ $data->email }}</td>
                                            <td>{{ $data->contact_number}}</td>
                                            <td>{{ $data->website  }}</td>
                                            <td>{{ $data->contact_person }}</td>
                                            <td>{{ $data->contact_person_number }}</td>
                                            <td>{{ $data->contact_person_address}} aaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaa</td>
